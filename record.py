...
class Record:
    ...
    def message_header(self,Platform):
        ...
        data = [
            ...
            self.station_name.center(40),  #                   string1 ID of station
            'Station name'.center(40),  #string2 Name of station
            Platform.ljust(40),  #string3 Description of the measurement device
